...
CSV.foreach("db/cookbooks.csv", headers: true) do |row|
 ...
 # 1 - 4 recipes.
ingredients_recipes = {1 => [21, 46, 18, 12, 20, 22, 11, 19], 2 => [23, 6, 12, 11, 24, 8, 13, 26, 25], 3 => [16, 47, 27, 28, 3, 17, 29, 48, 30, 31, 32, 33, 6, 34, 35, 41, 36, 37, 38], 4 => [39, 40, 37, 41, 42, 2, 28, 49, 50, 44, 45], 5 => [51, 52, 53, 54, 21, 42, 22, 48, 1, 49], 6 => [55, 56, 17, 25, 15, 11, 1] }
