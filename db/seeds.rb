...
recipes = [
  ...
  {name: "Girls Just Want to Have FUNdamental Rights", user_id: 2, cookbook_id: 4, description: "A strong mix for a strong woman.", prep: "Mix everything together, look at you getting stuff done!", image: File.open(File.join('app/assets/images/recipes/green.jpeg')) }, #8
